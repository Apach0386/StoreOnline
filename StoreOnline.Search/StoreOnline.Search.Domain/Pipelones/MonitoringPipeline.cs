...
namespace StoreOnline.Search.Domain.Pipelines;
...
public class MonitoringPipeline<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
{
    public MonitoringPipeline(IMeterFactory meterFactory)
    {
        ...
        _meter = _meterFactory.Create("StoreOnline.Search.Domain");
    }

    private static readonly ActivitySource ActivitySource = new ActivitySource("StoreOnline.Search");    
